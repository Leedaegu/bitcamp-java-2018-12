...
public class Servlet03 extends HttpServlet {
  ...
  protected void service(
    ...
    // => 웹 브라우저는 응답 받는 즉시 해당 페이지를메타데이터 요청한다.
    //    웹 서버로부터 콘텐트를 받지 않았기 때문에 어떤 것도 출력하지 않는다.
    //    바로 다른 페이지로 이동한다.
    // => 리프래시와 달리 서버는 콘텐드(message-body)를 보내지 않는다.
    // => 사용 예:
    ...
    /*
     ...
     Content-Length: 0
     Date: Tue, 02 Apr 2019 03:38:32 GMT
      빈줄
...
//    }
    ...
    // foward/include 와 달리 '/'는 컨텍스트 루트(웹 애플리케이션 루트)가 아닌
    // 웹 서버 루트를 의미한다.

    response.sendRedirect("/java-web/ex08/s100");
