...
public class Test12 {
  ...
  public static void main(String[] args) {     
    ...
    System.out.printf("%d %x %c %b\n", 65, 65, 65, true);
     ...
     // 한개의 값을 여러 곳에 삽입할 수 있다.
    // %n$s : n은 값의 순서를 지정한다. 순서는 1부터 증가한다.
    System.out.printf("%3$d %2$x %2$c\n", 65, 66, 67);
 
    // 값을 출력할 떄 사용할 공간을 지정할 수 있다.
    // %[사용할 공간너비]s : -는 왼쪽 정렬이다. 안 붙이면 기본 오른쪽 정렬이다.
    System.out.printf("'%-10s' '%10s'\n", "홍길동", "임꺽정");
    System.out.printf("'%-10d' '%10d'\n", 12345, 12345);
    
    //%[0][사용할공간너비]d : 앞의 빈자리는 0으로 채운다.
    //%[+][0][사용할공간너비]d : +는 숫자 앞에 부호를 붙인다.(%+가 +를출력하라는게아니라 뒤에입력한 값의 +,-를 출력한다)
