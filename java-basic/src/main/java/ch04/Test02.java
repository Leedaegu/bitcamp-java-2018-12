...
public class Test02 {
  public static void main(String[] args) {
    ...
    //System.out.println(true % false); //boolean 타입에 대해서는 산술 연산자를 사용할수 없다.
    //System.out.println(true + true); //컴파일 오류!
    System.out.println("Hello," + "World!"); //OK! '+'연산자는 문자열 연결 용도로 사용할수있다.
    //System.out.println("Hello," - "o,"); //컴파일오류!
