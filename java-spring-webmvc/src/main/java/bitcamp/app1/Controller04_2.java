...
public class Controller04_2 {
  ...
  //테스트
  // http://localhost:8080/java-spring-webmvc/app1/c04_2/h2?name1=kim&name2=eik

  @GetMapping("h2")
  @ResponseBody
  public void handler2(
      PrintWriter out,
      @RequestParam("name1") String name1,       // 애노테이션을 붙이면 필수 항목으로 인지한다 따라서 파라미터 값이 없으면 예외가 발생한다.
