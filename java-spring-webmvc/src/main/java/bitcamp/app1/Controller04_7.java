...
public class Controller04_7 {
  ...
  // 클라이언트가 보낸 쿠키 꺼내기
  // => @CookieValue(쿠키명) 애노테이션을 request의 아규먼트 앞에 붙인다.
  ...
  //테스트
  // http://localhost:8080/java-spring-webmvc/app1/c04_7/h2
  @GetMapping("h2")
  @ResponseBody
  public void handler2(
      ...
      @CookieValue(value="age", defaultValue="0") int age // String ==> int 자동변환
      ) { 
