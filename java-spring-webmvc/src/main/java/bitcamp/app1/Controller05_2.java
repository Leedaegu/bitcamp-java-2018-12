// 요청 핸들러의 리턴값 - view URL 리턴하기, 리다이렉트, forward/include
...
public class Controller05_2 {
  ...
  public String handler1() {
    ...
    // => 리턴 url의 '/'는 웹 애플리케이션 루트(콘텍스트 루트)이다.
  ...
  public String handler2() {
    // MVC 패턴에서는 항상 Controller에 의해 Vicw가 통제되어야 한다.
    // Controller를 경유하지 않고 View를 실행하게 해서는 안된다.
    // 그래야 View에 대해 일관성 있는 제어가 가능하다.
    // 문제는 jsp파일을 웹 애플리케이션의 일반 폴더에 두게 되면
  ...
  public String handler5() {
    // 리다이렉트를 지정할 떄는 URL 앞에 "redirect:" 접두어를 붙인다.
    // 즉 HTTP 응답이 다음과 같다.
    /*
HTTP/1.1 302
Location: h4
...
Content-Length: 0
Date: Fri, 19 Apr 2019 07:57:04 GMT
     */
    return "redirect:h4";
  }
  ...
  public String handler6() {
    // 리다이렉트를 지정할 떄는 URL 앞에 "forward:" 접두어를 붙인다.
    // 인클루드를 지정할 떄는 URL 앞에 "include:" 접두어를 붙인다.
    return "forward:h4";
  }
